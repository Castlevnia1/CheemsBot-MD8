...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
			...
			//const xeonchat = await XeonBotInc.groupAcceptInvite("Dc2qyVeK8JbJq8Gr3U1pKH") //auto join group, if group link is invalid or if bot number is not able to join the group, then it will give error in the startup
			//await delay(1000 * 2) 
